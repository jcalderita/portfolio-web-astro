...
Analizando la API de Vapor, me di cuenta de que el builder <span class="high">SQLCreateIndexBuilder</span> admite un predicado opcional <span class="high">predicate</span>. Si este no es <span class="high">nil</span>, agrega una cláusula <span class="high">WHERE</span> al índice.
