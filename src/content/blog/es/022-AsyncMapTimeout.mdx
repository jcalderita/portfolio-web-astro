...
En el [post sobre AsyncMap](/blog/es/async-map-es) vimos cómo procesar colecciones de forma **secuencial asíncrona**. Sin embargo, al trabajar con **APIs externas** que implementan rate limiting, nos enfrentamos a un problema crítico:
