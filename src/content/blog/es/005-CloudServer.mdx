...
⏱️ Hasta **3.000 OCPU-horas** al mes<br />
🧠 Hasta **18.000 GB-horas de memoria** al mes<br />
🚀 1 servidor con **4 OCPUs + 24 GB RAM** funcionando 24/7<br />
🔄 O varias instancias más pequeñas (ejemplo: 4 × 1 OCPU + 6 GB RAM)<br />
💾 Hasta **200 GB combinados** entre volúmenes de arranque y bloques<br />
♾️ **Gratuito indefinidamente**, siempre dentro de los límites del plan<br />
⚠️ Oracle puede **reclamar instancias inactivas** (sin uso significativo en 7 días)<br />
🌍 Puede haber **restricciones regionales** por falta de capacidad<br />
